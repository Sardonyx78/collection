...
declare class Collection<K, V> extends Map<K, V> {
     ...
     * amount is negative
     */
    first<T extends V>(): T | undefined;
    first<T extends V>(amount: number): T[];
    /**
     ...
     * amount is negative
     */
    last<T extends V>(): T | undefined;
    last<T extends V>(amount: number): T[];
    /**
     ...
     */
    random<T extends V>(): T;
    random<T extends V>(amount: number): T[];
    /**
     ...
     */
    find<T extends V>(fn: (value: T, key: K, collection: this) => boolean): T | undefined;
    find<L, T extends V>(fn: (this: L, value: T, key: K, collection: this) => boolean, thisArg: L): T | undefined;
    /**
